...
\usepackage{tikz-feynman}
    % tikz libraries
    \usetikzlibrary{arrows,matrix,arrows.meta,shapes, patterns.meta}
...
\newcommand{\thesistitle}{Non-perturbative calculation of the spectrum of excitons in low-dimensional systems, using lattice stochastic methods}
\newcommand*{\thesisauthor}{Petar Sinilkov}
...
\newcommand*{\thesismonth}{11 September}
...
\graphicspath{%
  ...
  {figs/cover/}%
  {figs/figures/}%
  {figs/figures/infVolLim/phhp}%
  {figs/figures/infVolLim/pppp}%
  {figs/figures/zeroTempLim/thesisU3/phhp_u3}%
  {figs/figures/zeroTempLim/thesisU3/pppp_u3}%
  {figs/figures/zeroTempLim/thesisU4/phhp_u4}%
  {figs/figures/zeroTempLim/thesisU4/pppp_u4}%
}
...
\include{thesis_formalism}
\include{thesis_methods}
\include{thesis_sym}
\include{thesis_excitons}
\include{thesis_conclusion.tex}
